...
/-!
# Step 8 — Case-3 residual enumeration: `w = 2` native-decide slice
...
/-- `allBalanced 2 7 = true`: the `|Q| ≤ 7` slice of the `w = 2`
residual (`102784` configurations). -/
theorem case3_balanced_w2 : allBalanced 2 7 = true := by
  native_decide
