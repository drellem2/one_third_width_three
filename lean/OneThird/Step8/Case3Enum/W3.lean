...
/-!
# Step 8 — Case-3 residual enumeration: `w = 3` native-decide slice
...
/-- `allBalanced 3 7 = true`: the `|Q| ≤ 7` slice of the `w = 3`
residual (`102784` configurations). -/
theorem case3_balanced_w3 : allBalanced 3 7 = true := by
  native_decide
