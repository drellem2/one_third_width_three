...
\begin{enumerate}[nosep, label=(\roman*)]
  ...
  a chain, $P$ has a balanced pair. This slice is verified by the
  exhaustive Python enumeration described in
  Remark~\ref{rem:residual-base} below
  (\texttt{lean/scripts/enum\_cap5.py}). It does not depend on
  Steps~1--7 or on Hypothesis~\ref{hyp:arith}.
